...
export function createNotificationService(params: ExternalParams) {
  ...
  notificationService: scoped(container => new NotificationServiceImpl(container.get('userService'), container.get('logger'))),
  };
